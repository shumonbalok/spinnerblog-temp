                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{route('posts.create')}}"
                                    class="underline text-gray-900 dark:text-white">Add New Post</a>
                                {{-- <a href="{{route('posts.create')}}" class="btn btn-primary"></a> --}}

                            </div>
                        </div>
                        @if (session()->has('success'))
                        <div class="text-primary" style="color:green">{{session()->get('success') }}</div>
                        @endif
                        @foreach ($posts as $post)
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                <p><a href="{{route('posts.show', $post)}}">Name: {{$post->name}}</a></p>
